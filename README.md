...
<head>
    ...
    <style>
        ...
        .comment .heart-btn {
            background-color: #8a63a1; /* Darker Purple Button */
            color: white;
            padding: 5px 10px;
            border: none;
            cursor: pointer;
